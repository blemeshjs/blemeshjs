...
export class ConfigModelAppBind extends Mixin(
  AcknowledgedConfigMessage,
  ConfigAppKeyMessage,
  ConfigAnyModelMessage,
) {
  public static readonly opCode: UInt32 = 0x803d;
  public override opCode: UInt32 = 0x803d;
  ...
  public static fromData(parameters: Data) {
    ...
    if (parameters.length === 8) {
      ...
      return new ConfigModelAppBind(applicationKeyIndex, elementAddress, modelIdentifier);
    }
  }
}
