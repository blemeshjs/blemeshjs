...
| `toProxy` | `toProxy(model: Model, coreMeshNetworkManager: CoreMeshNetworkManager): InternalModel & Pick<Model, never> & Pick<Model, "name" \| "companyIdentifier" \| "companyName" \| "isBluetoothSIGAssigned" \| "modelIdentifier" \| "isGenericOnOffServer" \| "modelId" \| "boundApplicationKeys" \| "applicationKeys">;` | No description yet. |
...
| `getModel` | `getModel(nodeUuid: string, elementIndex: number, modelId: number): InternalModel & Pick<Model, never> & Pick<Model, "name" \| "companyIdentifier" \| "companyName" \| "isBluetoothSIGAssigned" \| "modelIdentifier" \| "isGenericOnOffServer" \| "modelId" \| "boundApplicationKeys" \| "applicationKeys"> \| undefined;` | No description yet. |
...
**Source:** `packages/sdk/src/mesh-network/network-connection.ts#L190`
