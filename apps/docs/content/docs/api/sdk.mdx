...
**Source:** `packages/sdk/src/types/index.ts#L8`
...
```ts
type ConnectionStatus = "connecting" | "discovering-services" | "initializing" | "connected" | "disconnected";
```
...
**Source:** `packages/sdk/src/mesh-network/mesh-network-manager.ts#L39`
...
**Source:** `packages/sdk/src/mesh-network/network-connection.ts#L177`
...
**Source:** `packages/sdk/src/mesh-network/network-connection.ts#L36`
