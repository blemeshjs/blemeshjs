...
| `didReadRSSI` | `didReadRSSI(_: CBPeripheral, RSSI: Long, __?: Error): void;` | No description yet. |
...
| `didWriteValueForCharacteristic` | `didWriteValueForCharacteristic(_: CBPeripheral, __: CBCharacteristic, ___?: Error): void;` | No description yet. |
| `open` | `open(): void;` | No description yet. |
| `readRSSI` | `readRSSI(): void;` | No description yet. |
| `send` | `send(data: Data, type: PduType): void;` | No description yet. |
...
**Source:** `packages/core/src/mesh-models/model.ts#L38`
...
**Source:** `packages/core/src/mesh-models/node.ts#L82`
...
**Source:** `packages/core/src/mesh-models/node.ts#L135`
...
**Source:** `packages/core/src/mesh-models/node.ts#L51`
...
| `readRSSI` | `readRSSI(): void;` | No description yet. |
| `send` | `send(data: Data, type: PduType): void;` | No description yet. |
| `sendProvisioningRequest` | `sendProvisioningRequest(request: ProvisioningRequest): void;` | No description yet. |
| `supports` | `supports(pduType: PduType): boolean;` | No description yet. |
...
| `identify` | `identify(attentionTimer: number): void \| ProvisioningError \| BearerError;` | No description yet. |
| `obtainAuthValue` | `obtainAuthValue(): void;` | No description yet. |
| `provision` | `provision(algorithm: Algorithm, publicKey: PublicKey, authenticationMethod: AuthenticationMethod): ProvisioningError \| BearerError \| undefined;` | No description yet. |
